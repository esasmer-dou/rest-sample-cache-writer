...
This sample pulls `java-rust-cache` and `rust-sample-model` from GitHub Packages. Maven must authenticate before it can download the packages; this is GitHub Packages' normal access model.
